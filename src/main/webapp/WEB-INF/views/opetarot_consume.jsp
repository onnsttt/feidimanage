...
<%@ page import="fdweb.springboot.pojo.Consume_record" %><%--
...
<script>
    $(function () {
        // alert("123");
        var list=${consume_list};
        function t() {
            for(var i in list){
                var str ="<tr>";
                str+= "<td>"+list[i].consumeId+"</td>";
                str+="<td>"+list[i].userPhone+"</td>";
                str+="<td>"+list[i].consumeMoney+"</td>";
                str+="<td>"+list[i].consumeTime+"</td>";
                str+="<td>"+list[i].machineId+"</td>";
                str+="<td>"+list[i].transactionDate+"</td></tr>";
                // alert(str);
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">消费记录</div>
